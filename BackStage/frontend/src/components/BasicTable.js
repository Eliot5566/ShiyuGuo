    ...
    <Transition>
      ...
      <div className='container text-center px-4 border rounded-3 bg-white mt-3'>
        ...
        <div className="d-flex justify-content-end">
          ...
          <div className='pagination btn-group w-50 my-2 ms-2'>
            <button onClick={()=> table.setPageIndex(0)} className='btn btn-secondary'>第一頁</button>
            <button onClick={()=> table.previousPage()} disabled={!table.getCanPreviousPage()} className='btn btn-secondary'>上一頁</button>
            <button onClick={()=> table.nextPage()} disabled={!table.getCanNextPage()} className='btn btn-secondary'>下一頁</button>
            <button onClick={()=> table.setPageIndex(table.getPageCount()-1)} className='btn btn-secondary'>最後一頁</button>
          </div>
        </div>

...
// import AOS from 'aos';
// import 'aos/dist/aos.css'; // 导入AOS的CSS样式
        ...
        <div className="pagesContainer d-flex  align-items-center text background ">
          <div className="row mx-5  mt-5  align-items-center ">
            <div className="col-md-8">
              ...
              <br></br>
              <h4 className=" animate__fadeInDown  m-3 fw-bold lh-3 ">
            ...
            <div className="col-md-4">
              <img
                className="img-fluid handmade rounded mx-auto d-block align-items-center  "
                src={main1}
                alt=""
              />
            </div>
